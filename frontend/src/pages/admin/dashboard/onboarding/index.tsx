...
export default function OnboardingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-[#F5F7F8] py-12 px-4 sm:px-6 lg:px-8">
      <div className="flex justify-center mb-8">
        <Logo />
      </div>

      <div className="mt-8 text-center">
        <h2 className="text-5xl font-bold font-lora">Tell us about you</h2>
      </div>
