...
import { useResendEmailVerificationMutation, useVerifyEmailMutation } from "./hooks"
...
export default function VerifyEmailPage() {
  const {mutate: verifyCode, isPending: isVerifying, isError} = useVerifyEmailMutation()
  const {state} = useLocation()
  const {mutate: resendCode, isPending: isResending} = useResendEmailVerificationMutation()
